classdef InstancesClientTest < matlab.unittest.TestCase
    ...
    properties (TestParameter)
        ...
        % path for each of them instead of repeating it per operation. Each
        % value is {operationName, callArgs}, the arguments needed to reach
        % the operation's own request beyond the mock client itself.
        ErroringOperation = struct(...
            'createNewInstance',       {{'createNewInstance', {'{}'}}}, ...
            'createNewInstanceWithId', {{'createNewInstanceWithId', {"id1", '{}'}}}, ...
            'updateInstance',          {{'updateInstance', {"id1", '{}'}}}, ...
            'replaceInstance',         {{'replaceInstance', {"id1", '{}'}}}, ...
            'deleteInstance',          {{'deleteInstance', {"id1"}}}, ...
            'moveInstance',            {{'moveInstance', {"id1", "newspace"}}}, ...
            'releaseInstance',         {{'releaseInstance', {"id1"}}}, ...
            'getReleaseStatus',        {{'getReleaseStatus', {"id1"}}}, ...
            'listTypes',               {{'listTypes', {}}}, ...
            'runDynamicQuery',         {{'runDynamicQuery', {'{}'}}}, ...
            'getInstancesBulk',        {{'getInstancesBulk', {["id1", "id2"]}}} ...
            )
    end
