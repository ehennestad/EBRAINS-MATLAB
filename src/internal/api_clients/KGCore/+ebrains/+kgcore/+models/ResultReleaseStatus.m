classdef ResultReleaseStatus < ebrains.kgcore.JSONMapper
% ResultReleaseStatus No description provided
% 
% ResultReleaseStatus Properties:
%   data - type: string
%   message - type: string
%   error - type: Error
...
% MATLAB Generator for OpenAPI version: 1.0.9
    ...
    methods
        % Constructor
        function obj = ResultReleaseStatus(s,inputs)
            ...
            arguments
                ...
                inputs.?ebrains.kgcore.models.ResultReleaseStatus
            end
