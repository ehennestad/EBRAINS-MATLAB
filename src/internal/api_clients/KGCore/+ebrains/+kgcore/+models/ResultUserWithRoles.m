classdef ResultUserWithRoles < ebrains.kgcore.JSONMapper
% ResultUserWithRoles No description provided
% 
% ResultUserWithRoles Properties:
%   data - type: UserWithRoles
%   message - type: string
%   error - type: Error
...
% MATLAB Generator for OpenAPI version: 1.0.9
    ...
    properties
        % data - type: UserWithRoles
        data ebrains.kgcore.models.UserWithRoles { ebrains.kgcore.JSONMapper.fieldName(data,"data") }
        % message - type: string
    ...
    methods
        % Constructor
        function obj = ResultUserWithRoles(s,inputs)
            ...
            arguments
                ...
                inputs.?ebrains.kgcore.models.ResultUserWithRoles
            end
