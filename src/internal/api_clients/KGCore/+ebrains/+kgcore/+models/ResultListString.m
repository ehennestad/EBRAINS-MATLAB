classdef ResultListString < ebrains.kgcore.JSONMapper
% ResultListString No description provided
% 
% ResultListString Properties:
...
% MATLAB Generator for OpenAPI version: 1.0.9
    ...
    properties
        % data - type: array of string
        data string { ebrains.kgcore.JSONMapper.fieldName(data,"data"), ebrains.kgcore.JSONMapper.JSONArray }
        % message - type: string
    ...
    methods
        % Constructor
        function obj = ResultListString(s,inputs)
            ...
            arguments
                ...
                inputs.?ebrains.kgcore.models.ResultListString
            end
