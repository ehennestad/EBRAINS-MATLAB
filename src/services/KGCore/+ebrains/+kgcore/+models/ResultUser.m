classdef ResultUser < ebrains.kgcore.JSONMapper
% ResultUser No description provided
% 
% ResultUser Properties:
%   data - type: ResultUser_data
%   message - type: string
%   error - type: Error
...
% MATLAB Generator for OpenAPI version: 1.0.9
    ...
    methods
        % Constructor
        function obj = ResultUser(s,inputs)
            ...
            arguments
                ...
                inputs.?ebrains.kgcore.models.ResultUser
            end
