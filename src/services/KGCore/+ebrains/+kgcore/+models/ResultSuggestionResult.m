classdef ResultSuggestionResult < ebrains.kgcore.JSONMapper
% ResultSuggestionResult No description provided
% 
% ResultSuggestionResult Properties:
%   data - type: SuggestionResult
%   message - type: string
%   error - type: Error
...
% MATLAB Generator for OpenAPI version: 1.0.9
    ...
    properties
        % data - type: SuggestionResult
        data ebrains.kgcore.models.SuggestionResult { ebrains.kgcore.JSONMapper.fieldName(data,"data") }
        % message - type: string
    ...
    methods
        % Constructor
        function obj = ResultSuggestionResult(s,inputs)
            ...
            arguments
                ...
                inputs.?ebrains.kgcore.models.ResultSuggestionResult
            end
