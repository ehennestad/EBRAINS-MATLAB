classdef ResultSpaceInformation < ebrains.kgcore.JSONMapper
% ResultSpaceInformation No description provided
% 
% ResultSpaceInformation Properties:
%   data - type: ResultSpaceInformation_data
%   message - type: string
%   error - type: Error
...
% MATLAB Generator for OpenAPI version: 1.0.9
    ...
    methods
        % Constructor
        function obj = ResultSpaceInformation(s,inputs)
            ...
            arguments
                ...
                inputs.?ebrains.kgcore.models.ResultSpaceInformation
            end
