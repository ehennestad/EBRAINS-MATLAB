classdef ResultVoid < ebrains.kgcore.JSONMapper
% ResultVoid No description provided
% 
% ResultVoid Properties:
%   data - type: object
%   message - type: string
%   error - type: Error
...
% MATLAB Generator for OpenAPI version: 1.0.9
    ...
    methods
        % Constructor
        function obj = ResultVoid(s,inputs)
            ...
            arguments
                ...
                inputs.?ebrains.kgcore.models.ResultVoid
            end
