classdef SpaceTypeInformation < ebrains.kgcore.JSONMapper
% SpaceTypeInformation No description provided
% 
% SpaceTypeInformation Properties:
...
%   https__core_kg_ebrains_eu_vocab_meta_space - type: string
...
% MATLAB Generator for OpenAPI version: 1.0.9
    ...
    properties
        ...
        % https__core_kg_ebrains_eu_vocab_meta_space - type: string
        https__core_kg_ebrains_eu_vocab_meta_space string { ebrains.kgcore.JSONMapper.fieldName(https__core_kg_ebrains_eu_vocab_meta_space,"https://core.kg.ebrains.eu/vocab/meta/space") }
    end

    % Class methods
    methods
        % Constructor
        function obj = SpaceTypeInformation(s,inputs)
            ...
            arguments
                ...
                inputs.?ebrains.kgcore.models.SpaceTypeInformation
            end
