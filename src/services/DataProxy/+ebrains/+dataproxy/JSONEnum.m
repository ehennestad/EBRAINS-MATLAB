classdef (Abstract) JSONEnum
    % JSONEnum Base class for enumerations when working with ebrains.dataproxy.JSONMapper
    % When adding enumeration properties to ebrains.dataproxy.JSONMapper objects, the custom
