classdef JSONMapperMap < handle 
    ...
    methods
        ...
        function obj = subsasgn(obj,S,B)
            ...
            if isempty(obj)
                obj = ebrains.dataproxy.JSONMapperMap;
            end
        ...
        function disp(obj)
            ...
            if isempty(obj)
                disp 'Empty ebrains.dataproxy.JSONMapperMap'
                return
            end
            fprintf('ebrains.dataproxy.JSONMapperMap with the following key-value pairs:\n\n');
            for k = obj.map.keys
                fprintf('\t%10s : %s\n',k{1},obj.map(k{1}));
            end
        end
