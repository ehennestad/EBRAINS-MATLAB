classdef ResultScopeElement < ebrains.kgcore.JSONMapper
% ResultScopeElement No description provided
% 
% ResultScopeElement Properties:
%   data - type: ScopeElement
%   message - type: string
%   error - type: Error
...
% MATLAB Generator for OpenAPI version: 1.0.9
    ...
    properties
        % data - type: ScopeElement
        data ebrains.kgcore.models.ScopeElement { ebrains.kgcore.JSONMapper.fieldName(data,"data") }
        % message - type: string
    ...
    methods
        % Constructor
        function obj = ResultScopeElement(s,inputs)
            ...
            arguments
                ...
                inputs.?ebrains.kgcore.models.ResultScopeElement
            end
