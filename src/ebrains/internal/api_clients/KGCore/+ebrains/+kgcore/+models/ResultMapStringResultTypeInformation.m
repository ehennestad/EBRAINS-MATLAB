classdef ResultMapStringResultTypeInformation < ebrains.kgcore.JSONMapper
% ResultMapStringResultTypeInformation No description provided
% 
% ResultMapStringResultTypeInformation Properties:
...
% MATLAB Generator for OpenAPI version: 1.0.9
    ...
    methods
        % Constructor
        function obj = ResultMapStringResultTypeInformation(s,inputs)
            ...
            arguments
                ...
                inputs.?ebrains.kgcore.models.ResultMapStringResultTypeInformation
            end
