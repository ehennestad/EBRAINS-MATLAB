classdef (Abstract) JSONEnum
    % JSONEnum Base class for enumerations when working with ebrains.kgcore.JSONMapper
    % When adding enumeration properties to ebrains.kgcore.JSONMapper objects, the custom
