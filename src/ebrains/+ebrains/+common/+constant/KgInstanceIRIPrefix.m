...
%   IRI = KgInstanceIRIPrefix() returns the part of a Knowledge Graph
%   instance IRI that precedes the UUID, without a trailing slash. The KG
%   API clients strip it from identifiers before sending a request.
%
